...
juju deploy --repository juju-scaleio local:trusty/scaleio-sds scaleio-sds-pd1 --to $m1
...
juju deploy --repository juju-scaleio local:trusty/scaleio-sds scaleio-sds-pd2 --to $m2
