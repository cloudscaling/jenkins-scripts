...
set_fuel_options device-paths=$disk2
...
set_fuel_options rfcache-devices=$disk1
configure_cluster mode 1 primary-controller 1 compute 2,3

check_password 1 'Other_password'
check_protection_domain 1 'pd'
check_sp_name 1 'sp'
check_path 1 'Device ' $disk2
...
check_path 1 'Rfcache device ' $disk1
