...
set_fuel_options device-paths='/dev/xvdg'
...
set_fuel_options rfcache-devices='/dev/xvdf'
configure_cluster mode 1 primary-controller 1 compute 2,3

check_password 1 'Other_password'
check_protection_domain 1 'pd'
check_sp_name 1 'sp'
check_path 1 'Device ' '/dev/xvdg'
...
check_path 1 'Rfcache device ' '/dev/xvdf'
